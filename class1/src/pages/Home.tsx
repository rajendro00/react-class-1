    ...
    <section className="py-16">
      <div className="mx-auto max-w-[1152px]">
        ...
        <div className="mt-24 flex items-center justify-between gap-16">
          <div className="w-1/2">
            <img src={Unseen} alt="" className="w-full" />
          </div>
          <div className="w-1/2">
          <h2 className="text-[36px] font-semibold leading-[44px] text-[#4D4D4D]">
            ...
            <p className="mt-6 text-[#717171] leading-7">
            ...
            <button className="mt-8 rounded bg-[#4CAF4F] px-8 py-4 text-white hover:bg-green-600 transition">
              Learn More
            </button></div>
        </div>
      </div>
